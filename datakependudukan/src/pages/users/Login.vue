            ...
            <q-card flat class="bg-white text-black">
              <div class="row">
                ...
                <div class="col-md-12 col-xs-12 q-pt-md">
                  <div class="q-pa-md">
                    <div class="text-blue-grey-14 text-h4">LOGIN SINDAKEPKON</div>
                    ...
                    >
                      ...
                      <div>
                        <q-btn label="Login" type="submit" color="green" text-color="white" to="/Customer"/>
                        <q-btn label="Registrasi" to="/auth/Registrasi" color="green" flat class="q-ml-sm" />
                      </div>
                    </q-form>
